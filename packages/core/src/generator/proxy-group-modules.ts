...
export const PROXY_GROUP_MODULES: ProxyGroupModule[] = [
  ...
  },
  {
    ...
    emoji: "🪐",
    category: "service",
    description: "xAI Grok (grok.com、x.ai)",
    groupType: "select",
    rules: [{ id: "xai", name: "xAI Grok", behavior: "domain", path: "geosite/xai.mrs" }],
  },
  {
    id: "gpt",
    name: "💬 GPT",
    ...
    groupType: "select",
    rules: [{ id: "chatgpt", name: "OpenAI / ChatGPT", behavior: "domain", path: "geosite/openai.mrs" }],
  },
  {
    id: "claude",
    name: "🦀 Claude",
    ...
    groupType: "select",
    rules: [{ id: "claude", name: "Anthropic (Claude)", behavior: "domain", path: "geosite/anthropic.mrs" }],
  },
  {
    id: "youtube",
    name: "📹 油管视频",
